  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        cols: ["视图", "组件位置", "成熟度"],
        rows: [
          ["启动中心 launchpad", "LaunchpadView.tsx", "✅ 完整交互"],
          ["下载中心 download-ext", "DownloadExtView.tsx", "✅ 完整交互"],
          ["抽卡分组 lottery", "ClassroomViews.tsx", "✅ 可用"],
          ["计时器 timer", "ClassroomViews.tsx", "✅ 可用"],
          ["个人信息 / 设置", "ProfileView / SettingsView", "✅ 完整"],
          ["需求文档 spec-doc", "SpecDocView.tsx", "✅ 本文档页"],
          ["一键开课 / 班级看板 / 打卡单 / 复盘本 / 纪律", "ClassroomViews.tsx", "⚠️ 占位骨架，规则待定"],
        ],
      },
    ],
  },
