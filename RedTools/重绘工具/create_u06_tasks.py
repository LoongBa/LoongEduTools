...
TASKS = [
    ("pep1s_u06", "一年级", "上册", 42, 48),
    ("pep2s_u06", "二年级", "上册", 42, 48),
    ("pep3s_u06", "三年级", "上册", 62, 74),
    ("pep4x_u06", "四年级", "下册", 62, 74),
    ("pep5s_u06", "五年级", "上册", 62, 74),
    ("pep6s_u06", "六年级", "上册", 62, 74),
]
...
for name, grade, vol, start, end in TASKS:
    ...
    for p in pages:
        ...
        if src.exists():
            ...
            n += 1
    print(f"✅ {name} ({grade}{vol} U6): {n} 张输入图")
