...
TASKS = [
    ("pep1s_u03", "一年级", "上册", 18, 26),
    ("pep2s_u03", "二年级", "上册", 18, 26),
    ("pep3s_u03", "三年级", "上册", 26, 38),
    ("pep4x_u03", "四年级", "下册", 26, 38),
    ("pep5s_u03", "五年级", "上册", 26, 38),
    ("pep6s_u03", "六年级", "上册", 26, 38),
]
...
for name, grade, vol, start, end in TASKS:
    ...
    for p in pages:
        ...
        if src.exists():
            ...
            n += 1
    print(f"✅ {name} ({grade}{vol} U3): {n} 张输入图")
