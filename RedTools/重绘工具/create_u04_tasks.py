...
TASKS = [
    ("pep1s_u04", "一年级", "上册", 26, 34),
    ("pep2s_u04", "二年级", "上册", 26, 34),
    ("pep3s_u04", "三年级", "上册", 38, 50),
    ("pep4x_u04", "四年级", "下册", 38, 50),
    ("pep5s_u04", "五年级", "上册", 38, 50),
    ("pep6s_u04", "六年级", "上册", 38, 50),
]
...
for name, grade, vol, start, end in TASKS:
    ...
    for p in pages:
        ...
        if src.exists():
            ...
            n += 1
    print(f"✅ {name} ({grade}{vol} U4): {n} 张输入图")
