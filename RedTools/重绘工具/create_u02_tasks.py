...
# 任务: (任务名, 年级, 册, 起, 止[不含])
TASKS = [
    ("pep1s_u02", "一年级", "上册", 10, 18),
    ("pep2s_u02", "二年级", "上册", 10, 18),
    ("pep3s_u02", "三年级", "上册", 14, 26),
    ("pep4x_u02", "四年级", "下册", 14, 26),
    ("pep5s_u02", "五年级", "上册", 14, 26),
    ("pep6s_u02", "六年级", "上册", 14, 26),
]
...
for name, grade, vol, start, end in TASKS:
    ...
    for p in pages:
        ...
        if src.exists():
            ...
            n += 1
    print(f"✅ {name} ({grade}{vol} U2): {n} 张输入图 ({pages[0]:03d}-{pages[-1]:03d})")
