...
> 定位：教育工具产品矩阵规划 §6 扩展品类 P2「涂色游戏」（线稿图点击填色，美育）；扩展系列第三款。
> 需求与设计：`docs/工具文档/扩展/涂色游戏-设计文档.md`；用户操作指南：`docs/工具文档/扩展/涂色游戏-使用文档.md`。
...
```bash
python build_all.py --tool 涂色游戏
```

产物：`publish/扩展/涂色游戏.zip` + `涂色游戏-图标(1024).png`
...
- [x] docs/工具文档/扩展/涂色游戏-{设计,使用}文档.md
