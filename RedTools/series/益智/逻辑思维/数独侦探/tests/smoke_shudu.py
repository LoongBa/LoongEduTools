#!/usr/bin/env python3
"""数独侦探 冒烟测试（Playwright + 本地 chromium，file:// 协议）
...
def main():
    with sync_playwright() as p:
        ...
        # A. 首页
        check("A1 标题", page.locator(".header-title").inner_text() == "数独侦探")
        check("A2 版本", page.locator(".header-ver").inner_text().startswith("v1.12"))
